...
import org.linqs.psl.reasoner.conic.optimizer.ipm.HomogeneousIPMFactory;
...
public class ConicReasoner implements Reasoner {
	 ...
	 * 
	 * Should be set to a {@link org.linqs.psl.reasoner.conic.optimizer.ConicProgramSolverFactory}
	 * (or the binary name of one). The ConicReasoner will use this
	 * {@link org.linqs.psl.reasoner.conic.optimizer.ConicProgramSolverFactory} to
	 * instantiate a {@link org.linqs.psl.reasoner.conic.optimizer.ConicProgramSolver},
	 ...
	 * 
	 * Value is instance of {@link org.linqs.psl.reasoner.conic.optimizer.ipm.HomogeneousIPMFactory}.
	 */
